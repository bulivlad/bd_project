...
import ro.autoDealerSales.web.dao.EditPersonControllerImpl;
...
public class EditPersonServlet extends HttpServlet {
    ...
    private void saveData(HttpServletRequest req, HttpServletResponse resp,String id) {
        ...
        EditPersonControllerImpl personController = new EditPersonControllerImpl();
    ...
    protected void getData(HttpServletRequest req, HttpServletResponse resp, String id)throws ServletException, IOException{
        ...
        EditPersonControllerImpl personalInfo = new EditPersonControllerImpl();
...
//              CarForSale
        ...
        RequestDispatcher requestDispatcher = context.getRequestDispatcher("/editperson.jsp");
