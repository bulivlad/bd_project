...
import ro.autoDealerSales.web.dao.PersonalControllerImpl;
...
public class PersonalServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = context.getRequestDispatcher("/personalinfo.jsp");
...
//        Nu e chiar ce trebuie dar merge
        PersonalControllerImpl personalInfo = new PersonalControllerImpl();
