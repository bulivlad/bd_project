...
public class CarsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        CarDao carsController = new CarDaoImpl();
        ...
        if(action.equals("viewAll")){
            ...
            RequestDispatcher requestDispatcher = context.getRequestDispatcher(relativePathToView+"/car/info/carsgeneralinfo.jsp");
            requestDispatcher.include(req,resp);
        }
        else
            if(action.equals("addOne")){

                RequestDispatcher requestDispatcher = context.getRequestDispatcher(relativePathToView+"/car/addcar.jsp");
                requestDispatcher.include(req,resp);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(action.equals("viewOne")){
            ...
            RequestDispatcher requestDispatcher = context.getRequestDispatcher(relativePathToView+"/car/info/carsallinfo.jsp");
            requestDispatcher.include(req,resp);
        }
        else{
            if(action.equals("editOne")){
                ...
                if(update.equals("no")) {
                    ...
                    RequestDispatcher requestDispatcher = context.getRequestDispatcher(relativePathToView+"/car/editcar.jsp");
                    requestDispatcher.include(req, resp);
                }
                else{
